...
class Config
{
    ...
    public static string[] Dependencies { get; set; } = new[] { "0Harmony.dll", "UnityEngine.IMGUIModule.dll", "UnityEngine.ImageConversionModule.dll", "UnityEngine.dll", "UnityEngine.CoreModule.dll", "Assembly-CSharp.dll", "Unity.TextMeshPro.dll", "UnityEngine.UI.dll" };
...
{
    static string MOD_NAME = "OldMods"; // Change this to the name of your mod
